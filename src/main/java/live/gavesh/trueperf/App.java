...
public class App {
	...
	public static void main(String[] args) throws Exception {
		...
		if (!ps.isPowerShellAvailable()) {
			JOptionPane.showMessageDialog(null, "Please Install PowerShell", "Powershell Required", JOptionPane.ERROR_MESSAGE);
			Logger.error("Please install PowerShell first!");
			return;
		}
//		if (!WindowsUtils.isAdministrator()) {
//			JOptionPane.showMessageDialog(null, "Restart the application again 'As Administrator'", "Adminstrator Privilages Required", JOptionPane.ERROR_MESSAGE);
//			Logger.error("Restart the application again 'As Administrator'");
//			return;
//		}
